...
class Blockchain(object):
	...
	def new_block(self, proof, previous_hash=None):
		...
		:param previous_hash: (Optional) <srt> Hash of previous block
	...
	def resolve_conflicts(self):
		...
		# We're only looking fo chains longer than ours
...
def mine():
	...
	# The sender is "0" to signify the this node has mined a new coin.
